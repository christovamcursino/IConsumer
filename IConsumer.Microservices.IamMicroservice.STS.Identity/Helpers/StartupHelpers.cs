...
using SendGrid;
using IConsumer.Microservices.IamMicroservice.STS.Identity.Configuration;
using IConsumer.Microservices.IamMicroservice.STS.Identity.Configuration.ApplicationParts;
using IConsumer.Microservices.IamMicroservice.STS.Identity.Configuration.Constants;
using IConsumer.Microservices.IamMicroservice.STS.Identity.Configuration.Interfaces;
using IConsumer.Microservices.IamMicroservice.STS.Identity.Helpers.Localization;
using IConsumer.Microservices.IamMicroservice.STS.Identity.Services;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using IConsumer.Microservices.IamMicroservice.Admin.EntityFramework.MySql.Extensions;
using IConsumer.Microservices.IamMicroservice.Admin.EntityFramework.PostgreSQL.Extensions;
using IConsumer.Microservices.IamMicroservice.Admin.EntityFramework.Shared.Configuration;
using IConsumer.Microservices.IamMicroservice.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;

namespace IConsumer.Microservices.IamMicroservice.STS.Identity.Helpers
{
