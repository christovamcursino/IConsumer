...
using IConsumer.Microservices.IamMicroservice.STS.Identity.ViewModels.Account;

namespace IConsumer.Microservices.IamMicroservice.STS.Identity.Controllers
{
    [SecurityHeaders]
    [Authorize]
